...
<script>
import { companyForm } from "~/components/company/_mixin/form";
import BusinessCombobox from "~/components/company/combobox/business";
import IndustryCombobox from "~/components/company/combobox/industry";
export default {
  mixins: [companyForm],
  components: {
    BusinessCombobox,
